...
$query = "INSERT into tenant(email,username,phone_number,password) VALUES('" . $email . "','" . $username . "','" . $phone_number . "','" . $password . "')";
...
<div class="container">
	<div class="jumbotron" style="text-align: center;">
		...
		<h1>Selamat berjualan</h1>
		<p>Login <a href="tenantlogin.php">HERE</a></p>
	</div>
</div>
