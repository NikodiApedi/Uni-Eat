...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="foodlist.php"><span class="glyphicon glyphicon-shopping-cart"></span>
             (<?php
...
<td>Rp. <?php echo number_format ($values["food_price"]); ?></td>
<td>Rp.<?php echo number_format($values["food_quantity"] * $values["food_price"]); ?></td>
...
if(empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        <h1>Belanjaan Anda Kosong</h1>
        <p>Kembali ke List Makanan, <a href="foodlist.php">order now.</a></p>
